...
from priors.graph_builder_ancestral import GraphBuilder
...
class ObservationalDataLoader(DataLoader):
    """
    Like the usual observational dataloader, except that a probabilistic adjacency matrix is first sampled,
    from which a concrete graph as well as confounding information is produced.
    """
    def __init__(self,
                 num_steps: int,
                 batch_size: int, 
    ...
    def batch_function(self):
        ...
        graph, new_graph, confounding_graph = graph_builder.sample_graph(self.generator)
        ...
        full_data['graph_information'] = {
            ...
            'graph': graph,
            'new_graph': new_graph,
            'confounding_graph': confounding_graph,
            'scm': scm,
