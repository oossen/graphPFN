...
class ObservationalDataLoader(DataLoader):
    """
    Like the usual observational dataloader, except a probabilistic adjacency matrix is first sample
    from which a concrete graph is then sampled. The matrix is passed on as input to the model.
    """
    def __init__(self,
                 num_steps: int,
                 batch_size: int, 
