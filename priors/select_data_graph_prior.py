...
def select_features(data: Dict[int, torch.Tensor],
                    ...
                    ) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor, np.ndarray, nx.DiGraph]:
    """
    ...
    perm.append(target_node)
    perm = np.array(perm)
    prob_adj = prob_adj[perm[:, None], perm]
    ...
    return X, y, adjacency_matrix, prob_adj, new_graph