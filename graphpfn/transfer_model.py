...
class GraphPFNModel(nn.Module):
    def __init__(self, embedding_size: int, 
        ...
        # decoder
        self.decoder = nn.Sequential(TransformerEncoderLayer(embedding_size, num_attention_heads, mlp_hidden_size),
                                     Decoder(embedding_size, mlp_hidden_size, num_outputs))
