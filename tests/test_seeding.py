...
loader_1 = ObservationalDataLoader(3, 10, prior_config, preprocessing_config, seed=42)
loader_2 = ObservationalDataLoader(3, 10, prior_config, preprocessing_config, seed=42)
